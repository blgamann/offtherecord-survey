...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "솔직한 나를 방해하는 내면의 비판자 <방해꾼의 방>, 있는 그대로의 나를 드러내지 못하게 하는 내면의 방해꾼을 발견해 보세요.",
    type: "website",
    url: "https://offtherecord.nicetomeetme.kr",
    images: [
      {
        url: "https://offtherecord.nicetomeetme.kr/opengraph-image.png",
        width: 340,
        height: 211,
        alt: "오프더레코드 - 방해꾼의 방",
      },
  ...
  twitter: {
    ...
    description:
      "솔직한 나를 방해하는 내면의 비판자 <방해꾼의 방>, 있는 그대로의 나를 드러내지 못하게 하는 내면의 방해꾼을 발견해 보세요.",
    images: ["https://offtherecord.nicetomeetme.kr/opengraph-image.png"],
  },
};
